...
public class MetaDataTest {
	...
	String[] columnsNames = {"ID" , "Name" , "School" , "Age" , "Grades" , "GraduationDate"};
	String[] columnsTypes = {"int" , "varchar" , "varchar" , "int" , "float" , "date"};
	String tableName = "Students";
	
	ResultSetMetaData metaData = new ResultSetMetaData(columnsNames, columnsTypes, tableName);
